...
},{"./authenticationForm.js":4,"./dynaForm.js":5,"jquery":2,"jquery-mockjax":1}],4:[function(require,module,exports){
'use strict';
...
module.exports = function (options) {
  ...
  for (var field in settings.fields) {
    if (settings.fields[field].length > 0) {
      ...
      settings.fields[field].forEach(function (value) {
...
},{"./authenticationForm.js":4,"./formValidation.js":6,"jquery":2}],6:[function(require,module,exports){
"use strict";
...
module.exports = function () {
  ...
  function validateField(field, data) {
    if (data.length > validationRules[field].maxLength || data.lenght < validationRules[field].minLength) {
  ...
  function validate(json) {
    if (json.lead.username.length > validationRules.username.maxLength || json.lead.username.length < validationRules.username.minLength) {
      validateField('username', json.lead.username);
    }
    if (json.lead.email.length > validationRules.email.maxLength || json.lead.email.length < validationRules.email.minLength) {
